...
Call log:
  - waiting for getByPlaceholder('dd-mm-yyyy')
              ...
              - generic [ref=e451]:
                ...
                - radiogroup "Gender" [ref=e453]:
                  ...
                  - generic [ref=e456] [cursor=pointer]:
                    - radio "Female" [checked] [active] [ref=e457]
                    - text: Female
                - generic [ref=e458]:
                  - generic [ref=e459]:
...
```ts
  ...
  13 |             date: '26-08-2022',
  14 |             profession: ['Automation Tester', 'Manual Tester'],
  15 |             tools: ['Selenium WebDriver', 'Playwright'],
  16 |             continent: 'Asia',
  ...
  21 | 
  22 |         await expect(page.locator('.submission-output')).toContainText([
  23 |             userInfo.firstName,
  24 |             userInfo.lastName,
  25 |             userInfo.gender,
  26 |             userInfo.yearsOfExperience.toString(),
  27 |             userInfo.date,
  28 |             ...userInfo.profession,
  29 |             ...userInfo.tools,
  30 |             userInfo.continent,
  31 |             ...userInfo.commands
  32 |         ]);
  33 |     });
  34 | });
  35 | 
...
> 54 |     await page.getByPlaceholder('dd-mm-yyyy').fill(userData.date);
     |                                               ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  ...
  60 |     }   
  61 |     await page.selectOption('#continents', userData.continent);
  62 |     await page.getByRole('tab',{name: 'Switch Commands'}).click();
  63 |     await page.locator('#upload-image').setInputFiles('\tests\Projects\QA_Profile_Form_Filling\QAProfile.txt');
  64 |     await page.getByRole('button',{name : 'Save profile'}).click();
  65 |    
  66 | 
  67 | }
```