...
Call log:
  ...
  - waiting for locator('//p[text()=\'Total Balance\']/following-sibling::h3')
    14 × locator resolved to <h3 class="mt-2 text-3xl font-bold">$45,000.00</h3>
...
> 41 |     await expect(page.locator("xpath=//p[text()='Total Balance']/following-sibling::h3")).toContainText(expectedFundValue.toString());
     |                                                                                           ^ Error: expect(locator).toContainText(expected) failed
  42 | 
  43 | 
  44 | }
